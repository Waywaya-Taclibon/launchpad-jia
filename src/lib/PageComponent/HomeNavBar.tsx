    ...
    <nav className={`home-navbar ${isStickyMobileMenu ? "sticky" : ""}`}>
      <div className="navbar-container">
        <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
            ...
            <div className="mobile-menu">
              <div className="mobile-menu-container">
                ...
                >
                  ...
                  <a href="/developer#contact-us" className="nav-link">
                    Contact Us
                  </a>
                </div>
              </div>
          ...
          <a href="/#how-it-works" className="navbar-links">
            How it works
          </a>
          <a href="/#testimonials" className="navbar-links">
            Testimonials
          </a>
          <a href="/#newsletter" className="navbar-links">
            Newsletter
          </a>
        ...
        >
          <a className="navbar-links">For Job Hunters</a>
